...
[Vagrant](https://www.vagrantup.com/docs/why-vagrant/){:target="_blank"}{:target="_blank"} is a virtual machine manager. It is easy to configure and comes by default support of Docker, VirtualBox, VMware as providers. The great thing about Vagrant is that you can use all modern provisioning tools (e.g Chef, Puppet, Ansible) to install and configure software on the virtual machine.
